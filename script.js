    ...
    if(mer < 12)
    {
        ...
        if(change1[1]=="AM" || change2[1]=="AM" || change3[1]=="AM" || change4[1]=="AM")
        {
            if(parseInt(alarm1.value)==mer)
            {
                ...
                chngImg.innerHTML = "<img src='./image/compo.svg' alt='breakfast time'>";
            }
            if(parseInt(alarm2.value)==mer)
            {
                msg2.innerText = "LET'S HAVE SOME LUNCH !!";
                chngImg.innerHTML = "<img src='./image/group.svg' alt='lunch time'>";
            }
            if(parseInt(alarm3.value)==mer)
            {
                msg2.innerText = "STOP YAWNING, GET SOME TEA... ITS JUST EVENING!";
                chngImg.innerHTML = "<img src='./image/timeline.svg' alt='evening snacks' >";
            }
            if(parseInt(alarm4.value)==mer)
            {
                msg2.innerText = "CLOSE YOUR EYES AND GO TO SLEEP";
                chngImg.innerHTML = "<img src='./image/goodnight_image.svg' alt='good night'>";
            }
        }
    }
    else
    {
        if(mer>=12 && mer<24)
        {
            ...
            if(change1[1]=="PM" || change2[1]=="PM" || change3[1]=="PM" || change4[1]=="PM")
            {
                ...
                {
                    msg2.innerText = "GRAB SOME HEALTHY BREAKFAST!!!";
                    chngImg.innerHTML = "<img src='./image/nap_time.svg' alt='breakfast time'>";
                }
                if(parseInt(alarm2.value)==mer)
                {
                    msg2.innerText = "LET'S HAVE SOME LUNCH !!";
                    chngImg.innerHTML = "<img src='./compo.svg' alt='lunch time'>";
                }
                if(parseInt(alarm3.value)==mer)
                {
                    msg2.innerText = "STOP YAWNING... GET SOME TEA !";
                    chngImg.innerHTML = "<img src='./image/group.svg' alt='evening snacks'>";
                }
                if(parseInt(alarm4.value)==mer)
                {
                    msg2.innerText = "CLOSE YOUR EYES AND GO TO SLEEP";
